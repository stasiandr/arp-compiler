...
export async function activate(context: ExtensionContext) {
  ...
  const traceOutputChannel = window.createOutputChannel("Arp Language Server trace");
  const command = process.env.SERVER_PATH || "arpc";
  ...
  let clientOptions: LanguageClientOptions = {
    ...
    documentSelector: [{ scheme: "file", language: "arp" }],
    synchronize: {
  ...
  client = new LanguageClient("arp-language-server", "arp language server", serverOptions, clientOptions);
